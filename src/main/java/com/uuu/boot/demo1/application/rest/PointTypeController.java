...
public class PointTypeController {
    ...
    @PostMapping
    CreatePointTypeResponse createPointTypeRequeest(@RequestBody CreatePointTypeRequest createPointTypeRequeest) {
        PointType type = new PointType(createPointTypeRequeest.getType()
                , createPointTypeRequeest.getDescription());
